...
<?php
			...
			{
				$form = true;
				$message = 'The email address you typed is not valid.';
			}
		}
		else
		{
...
<div class="box">
    ...
    <form action="signup.php" method="post">
        ...
        <div class="center">
            ...
            <label for="avatar">Course<span class="small">(MCA/MSC/PGDCSA)</span></label><input type="text" name="avatar" value="<?php if(isset($_POST['avatar'])){echo htmlentities($_POST['avatar'], ENT_QUOTES, 'UTF-8');} ?>" /><br />
